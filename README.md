...
- **⚡ 방어 속도(타수) & 난이도 비례 점수** — 타수는 **한컴 타자연습과 같은 "자소 단위"**(자모 하나당 1타, 겹모음·겹받침만 2타)로 세되, 몬스터 대기 시간까지 포함한 판 전체 평균이라 순수 타자 속도와 구분해 **"방어 속도"**로 표시합니다. 점수는 제시어의 자모 획수에 비례해 어렵고 긴 단어일수록 높게 줍니다.
...
- **⏱️ 시작 카운트다운** — 게임 시작 시 첫 몬스터가 나오기까지의 5초를 화면 중앙에 크게 표시해 준비할 시간을 줍니다.
