...
- **👑 등급 & 명예의 전당** — 최고 도달 스테이지 기준 등급(SSS~D)과 TOP 5 리더보드(로컬 기본, Firebase 연동 시 글로벌). 전체 순위 보기에서는 **내 기록을 시안색으로 강조하고 내 등수로 자동 스크롤**해 한눈에 찾을 수 있습니다. 이번 판 MVP 시청자·글로벌 상위 %도 표시합니다.
