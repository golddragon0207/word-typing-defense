...
4. `게임 시작` → 화면 중앙 **카운트다운(5초)** 이 끝나면 첫 몬스터가 내려옵니다. 이 5초 동안 시청자가 `!참여`로 모일 수 있어요. 제시어를 타이핑해 막으면 됩니다.
...
- **⏱️ 시작 카운트다운** — 게임 시작 시 첫 몬스터가 나오기까지의 5초를 화면 중앙에 크게 표시하고, 이 시간 동안 `!참여`로 참전하도록 안내합니다.
